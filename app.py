...
def get_theme_vars():
    ...
    try:
        ...
        if not row:
            ...
            return '--bg:#f6f6f4;--bg2:#ffffff;--bg3:#f0f0ee;--border:#e8e8e4;--border2:#d0d0cc;--text:#18181b;--muted:#71717a;--hint:#a1a1aa;--radius:8px'
        ...
        if t.get('font') and t['font'] not in ('Inter', ''):
            vars_list.append(f"--sans:'{t['font']}',-apple-system,sans-serif")
